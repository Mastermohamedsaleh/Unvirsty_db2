 ...
 <i class="far fa-edit mb-5"></i>
            ...
            <div class="col-md-8">
              <div class="card-body p-4">
                ...
                <a href="#"  type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#cheangePass{{\Auth::guard('admin')->user()->id}}">Change Password</a>
...
<!-- Modal -->
<div class="modal fade" id="editprofileadmin{{\Auth::guard('admin')->user()->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="form-group">
        <label>Name: </label>
        <input type="text"  value="{{\Auth::guard('admin')->user()->name}}" name="name"  >
        </div>
      </div>
      ...
      <div class="form-group">
         <label>Email : </label>
         <input type="email" value="{{\Auth::guard('admin')->user()->email}}"  name="email"  >
         </div>
      </div>
...
<!-- Change pass -->
<div class="modal fade" id="cheangePass{{\Auth::guard('admin')->user()->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
