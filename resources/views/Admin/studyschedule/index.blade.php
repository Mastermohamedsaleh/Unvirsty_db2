...
<a href="{{route('studyschedule.create')}}" class="btn btn-primary mb-3">Add Schedule</a>
...
<form action="{{route('studyschedule.show','test')}}" method="get">
...
@include('Admin.studyschedule.edit')
@include('Admin.studyschedule.delete')
